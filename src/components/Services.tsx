      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-3xl font-bold tracking-tight text-primary sm:text-4xl font-mono">{t('services.process.title')}</h2>
            <p className="mt-6 text-lg leading-8 text-text/70">
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-4">
            {process.map((step) => (
              <div key={step.step} className="relative pl-9 group">
                ...
                <dd className="mt-2 text-sm text-text/60 group-hover:text-text/70 transition-colors">{step.description}</dd>
              </div>
            ))}
          </div>
        </div>
